    ...
    render() {
        ...
        if (this.props.fileName) {
            return (
                ...
                <div onClick={() => {this.fileInput.click()}} style={{backgroundColor: this.props.bgColor, color: 'white', borderStyle: 'dotted', borderColor: 'white', height: '50px'}}><p style={{margin: '5px'}}>📂<br/>{this.props.fileName}</p></div>
              </div>
            )
        } else {
            return (
